...
print("🔑 TWILIO_ACCOUNT_SID:", TWILIO_ACCOUNT_SID[:6] + "..." if TWILIO_ACCOUNT_SID else "❌ NOT SET")
print("🔑 TWILIO_AUTH_TOKEN:", TWILIO_AUTH_TOKEN[:6] + "..." if TWILIO_AUTH_TOKEN else "❌ NOT SET")
